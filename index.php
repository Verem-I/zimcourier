...
<?php include 'includes/navigation.php' ?>
    ...
    <div class="site-blocks-cover overlay" style="background-image:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <p><a href="#getstarted" class="btn btn-primary py-3 px-5 text-white">Get Started!</a></p>
...
<?php include 'includes/services.php ' ?>
    ...
    <div id="trackorder" class="site-blocks-cover overlay inner-page-cover" style="background-image:linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.9)), url(images/hero_bg_2.jpg); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
